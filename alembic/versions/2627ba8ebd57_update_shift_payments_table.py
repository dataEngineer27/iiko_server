...
def upgrade() -> None:
    ...
    op.add_column('shift_payments', sa.Column('orderdiscount_type_id', sa.ARRAY(UUID), nullable=True))
    op.add_column('shift_payments', sa.Column('orderincrease_type', sa.String(), nullable=True))
    op.add_column('shift_payments', sa.Column('orderincrease_type_id', sa.ARRAY(UUID), nullable=True))
